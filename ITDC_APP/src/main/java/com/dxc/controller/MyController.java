...
public class MyController {
	...
	public String addAdmin(@RequestParam int id,@RequestParam String pass,@RequestParam String repass, Model m)
	{
		...
		if(as.checkId(id))
		{
			String message="AdminIdis alreday in use. Please enter Different one";
		...
		else
		{
			...
			{
			    String message="Admin Created Sucessfully";
				m.addAttribute("message", message);
				return "message";
			}
			else
	...
	public String addUser(@RequestParam int id,@RequestParam String pass,@RequestParam String repass,Model m)
	{
		...
		else
		{
			...
			{
				 String message="User Created Sucessfully";
					m.addAttribute("message", message);
					return "message";
			}
			else {
	...
	if(as.hotelId(h))
		{
			String message="Hotel_Id  is alreday in use. Please enter Different one";
			m.addAttribute("message", message);
			return "message";
		}
		else
